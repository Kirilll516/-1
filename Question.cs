...
namespace Курсовая1._3
{
    public partial class Question : Form
    {
        ...
        string connectionString = "Data Source =Cab109, 49172; Initial Catalog = master2; Integrated Security = True; Encrypt = False";
            ...
            {
                questions = new string[2]; // Инициализируем массив для хранения вопросов
                answers = new string[2, 3]; // Инициализируем массив для хранения ответов (2 вопроса, 3 ответа)
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            currentIndex = (currentIndex + 1) % questions.Length; // Переходим к следующему индексу
